...
namespace kkl{
    ...
    /**
     * @brief univariate gaussian PDF 單變量高斯 PDF
     */
		template<typename T>
    ...
    /**
     * @brief multivariate gaussian PDF 多元高斯PDF
     */
...
#ifdef _USE_BOOST_ERF
    /**
     * @brief univariate cumulative probability function 單變量累積概率函數
     */
		template<typename T>
    ...
    /**
     * @brief compute an error ellipse 計算誤差橢圓
     */
    ...
    /**
     * @brief squared mahalanobis distance 平方馬氏距離
     */
		template<typename T, int p>
    ...
    /**
     * @brief univariate squared mahalanobis distance 單變量平方馬氏距離
     */
		template<typename T>
